...
DATA = np.array(
    [[WEISFEILER_LEHMAN, MUTAG, H_0, 85.5, 0.9, 15.7/10 + 0.1, 7],
     ...
     [COUNT_SENS_NEIGH_HASH, ANDROID_FCG, H_0, 90.0, 0.0, (3600.0/10 + 100)/3600, 100],
     [COUNT_SENS_NEIGH_HASH, ANDROID_FCG, H_1, 90.0, 0.0, (3600.0/10 + 100)/3600, 100],
     [COUNT_SENS_NEIGH_HASH, ANDROID_FCG, H_2, 90.0, 0.0, (3600.0/10 + 100)/3600, 100],
     [COUNT_SENS_NEIGH_HASH, ANDROID_FCG, H_3, 90.0, 0.0, (3600.0/10 + 100)/3600, 100],
     [COUNT_SENS_NEIGH_HASH, ANDROID_FCG, H_4, 90.0, 0.0, (3600.0/10 + 100)/3600, 100],
     [COUNT_SENS_NEIGH_HASH, ANDROID_FCG, H_5, 90.0, 0.0, (3600.0/10 + 100)/3600, 100],
