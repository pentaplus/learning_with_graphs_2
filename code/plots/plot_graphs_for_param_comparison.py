...
# The module pyplot must be imported after the specification of the RC
# parameters
...
DATA = np.array(
    [[WL, MUTAG, H_0, 85.5, 0.9, 15.7/10 + 0.1, 7],
     ...
     [WL, ANDROID_FCG, H_0, 93.3, 0.5, ((1529.5 + 1655.5)/10 + 278.9)/3600,
      4530],
     [WL, ANDROID_FCG, H_1, 93.7, 0.3, ((5735.4 + 6149.4)/10 + 1073.5)/3600,
      807181],
     [WL, ANDROID_FCG, H_2, 93.7, 0.2, ((11029.5 + 11857.0)/10 + 2508.2)/3600,
      1953948],
     [WL, ANDROID_FCG, H_3, 93.1, 1.1, ((16799.5 + 18079.0)/10 + 4806.8)/3600,
      3175014],
     [WL, ANDROID_FCG, H_4, 93.5, 0.4, ((23409.4 + 24538.1)/10 + 7998.7)/3600,
      4418993],
     [WL, ANDROID_FCG, H_5, 93.3, 0.4, ((32145.7 + 32766.4)/10 + 12247.7)/3600,
      5673882],
     ...
     [CSNH, ANDROID_FCG, H_0, 92.5, 1.0, ((1523.2 + 1503.8)/10 + 1640.3)/3600,
      4530],
     [CSNH, ANDROID_FCG, H_1, 94.4, 0.1, ((4410.1 + 4296.2)/10 + 2435.5)/3600,
      742522],
     [CSNH, ANDROID_FCG, H_2, 94.6, 0.1, ((4958.5 + 4817.5)/10 + 3513.3)/3600,
      996877],
     [CSNH, ANDROID_FCG, H_3, 94.5, 0.0, ((5153.8 + 5029.5)/10 + 4816.1)/3600,
      1161715],
     [CSNH, ANDROID_FCG, H_4, 94.4, 0.1, ((4862.7 + 4745.9)/10 + 6269.6)/3600,
      1104893],
     [CSNH, ANDROID_FCG, H_5, 94.5, 0.1, ((5067.1 + 4918.3)/10 + 7755.4)/3600,
      1182199],
...
#     [CSNH_ALL, ANDROID_FCG, H_0, 93.1, 0.7,
#      ((1585.0 + 1510.3)/10 + 1699.1)/3600, 4530],
#     [CSNH_ALL, ANDROID_FCG, H_1, 93.8, 0.3,
#      ((5810.0 + 5537.1)/10 + 2534.5)/3600, 746670],
#     [CSNH_ALL, ANDROID_FCG, H_2, 93.5, 0.6,
#      ((11434.9 + 10918.3)/10 + 3946.7)/3600, 1698312],
#     [CSNH_ALL, ANDROID_FCG, H_3, 93.5, 0.4,
#      ((17808.0 + 17211.8)/10 + 6107.2)/3600, 2740659],
#     [CSNH_ALL, ANDROID_FCG, H_4, 93.3, 0.6,
#      ((23960.5 + 23222.7)/10 + 8987.9)/3600, 3663995],
#     [CSNH_ALL, ANDROID_FCG, H_5, 93.4, 0.3,
#      ((31428.6 + 31720.8)/10 + 12731.0)/3600, 4587380],
     ...
     [EK, ANDROID_FCG, R_1_6, 90.4, 2.3, ((2332.2 + 2368.8)/10 + 14951.6)/3600,
      307],
     [EK, ANDROID_FCG, R_2_6, 87.4, 3.5, ((3806.3 + 3837.4)/10 + 28330.0)/3600,
      615],
     [EK, ANDROID_FCG, R_3_6, 88.6, 1.8, ((4939.4 + 4959.0)/10 + 39367.0)/3600,
      923],
     [EK, ANDROID_FCG, R_4_6, 87.4, 2.3, ((5694.9 + 5828.0)/10 + 48818.0)/3600,
      1231],
     [EK, ANDROID_FCG, R_5_6, 89.4, 1.7, ((6468.5 + 6454.0)/10 + 56604.0)/3600,
      1539],
     [EK, ANDROID_FCG, R_6_6, 88.2, 2.6, ((7168.6 + 7133.8)/10 + 62868.8)/3600,
      1847]])
    ...
    for embedding in EMBEDDINGS:
        ...
        for mode in MODES:
            ...
            if mode == SCORES:
                ...
                if embedding == EK and dataset in [DD, NCI1, NCI109,
                                                   FLASH_CFG]:
