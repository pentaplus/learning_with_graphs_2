...
DATA = np.array(
    [[WL, MUTAG, H_0, 85.5, 0.9, 15.7/10 + 0.1, 7],
     ...
     [WL, ANDROID_FCG, H_0, 93.5, 0.2, (1529.5/10 + 278.9)/3600, 4530],
     [WL, ANDROID_FCG, H_1, 93.6, 0.3, (5735.4/10 + 1073.5)/3600, 807181],
     [WL, ANDROID_FCG, H_2, 93.6, 0.2, (11029.5/10 + 2508.2)/3600, 1953948],
     [WL, ANDROID_FCG, H_3, 93.3, 0.2, (16799.5/10 + 4806.8)/3600, 3175014],
     [WL, ANDROID_FCG, H_4, 93.6, 0.1, (23409.4/10 + 7998.7)/3600, 4418993],
     [WL, ANDROID_FCG, H_5, 93.5, 0.3, (32145.7/10 + 12247.7)/3600, 5673882],
     ...
     [CSNH, ANDROID_FCG, H_0, 92.0, 1.3, (1523.2/10 + 1640.3)/3600, 4530],
     [CSNH, ANDROID_FCG, H_1, 94.4, 0.1, (4410.1/10 + 2435.5)/3600, 742522],
     [CSNH, ANDROID_FCG, H_2, 94.6, 0.0, (4958.5/10 + 3513.3)/3600, 996877],
     [CSNH, ANDROID_FCG, H_3, 94.5, 0.0, (5153.8/10 + 4816.1)/3600, 1161715],
     [CSNH, ANDROID_FCG, H_4, 94.4, 0.1, (4862.7/10 + 6269.6)/3600, 1104893],
     [CSNH, ANDROID_FCG, H_5, 94.5, 0.0, (5067.1/10 + 7755.4)/3600, 1182199],
...
#     [CSNH_ALL, ANDROID_FCG, H_0, 93.0, 0.8, (1585.0/10 + 1699.1)/3600, 4530],
#     [CSNH_ALL, ANDROID_FCG, H_1, 93.7, 0.5, (5810.0/10 + 2534.5)/3600, 746670],
#     [CSNH_ALL, ANDROID_FCG, H_2, 93.5, 0.7, (11434.9/10 + 3946.7)/3600, 1698312],
#     [CSNH_ALL, ANDROID_FCG, H_3, 93.4, 0.6, (17808.0/10 + 6107.2)/3600, 2740659],
#     [CSNH_ALL, ANDROID_FCG, H_4, 93.7, 0.1, (23960.5/10 + 8987.9)/3600, 3663995],
#     [CSNH_ALL, ANDROID_FCG, H_5, 93.4, 0.2, (31428.6/10 + 12731.0)/3600, 4587380],
     ...
     [EK, ANDROID_FCG, R_1_6, 90.3, 2.3, (2332.2/10 + 14951.6)/3600, 307],
     [EK, ANDROID_FCG, R_2_6, 87.4, 3.8, (3806.3/10 + 28330.0)/3600, 615],
     [EK, ANDROID_FCG, R_3_6, 89.3, 1.9, (4939.4/10 + 39367.0)/3600, 923],
     [EK, ANDROID_FCG, R_4_6, 85.6, 2.2, (5694.9/10 + 48818.0)/3600, 1231],
     [EK, ANDROID_FCG, R_5_6, 91.0, 0.9, (6468.5/10 + 56604.0)/3600, 1539],
     [EK, ANDROID_FCG, R_6_6, 87.6, 3.1, (7168.6/10 + 62868.8)/3600, 1847]])
