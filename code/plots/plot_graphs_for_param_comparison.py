...
# !!!!!!!!!!! FEATURE EXTRACTION TIMES ARE WRONG !!!!!!!!!!!
     [EIGEN_KERNEL, MUTAG, R_1_6, 85.4, 0.5, 15.1/10 + 14.8, 2],
     [EIGEN_KERNEL, MUTAG, R_2_6, 87.2, 0.1, 15.2/10 + 14.8, 5],
     [EIGEN_KERNEL, MUTAG, R_3_6, 87.2, 0.2, 15.1/10 + 14.8, 8],
     [EIGEN_KERNEL, MUTAG, R_4_6, 86.3, 0.6, 15.3/10 + 14.8, 11],
     [EIGEN_KERNEL, MUTAG, R_5_6, 84.4, 0.7, 15.4/10 + 14.8, 14],
     [EIGEN_KERNEL, MUTAG, R_6_6, 84.2, 0.5, 15.2/10 + 14.8, 17],
     [EIGEN_KERNEL, PTC_MR, R_1_6, 54.5, 0.8, 16.1/10 + 62.5, 4],
     [EIGEN_KERNEL, PTC_MR, R_2_6, 57.6, 1.3, 16.4/10 + 62.5, 8],
     [EIGEN_KERNEL, PTC_MR, R_3_6, 58.6, 0.5, 16.2/10 + 62.5, 12],
     [EIGEN_KERNEL, PTC_MR, R_4_6, 57.3, 0.9, 19.4/10 + 62.5, 17],
     [EIGEN_KERNEL, PTC_MR, R_5_6, 57.6, 1.0, 23.7/10 + 62.5, 21],
     [EIGEN_KERNEL, PTC_MR, R_6_6, 58.0, 0.9, 23.5/10 + 62.5, 25],
     [EIGEN_KERNEL, ENZYMES, R_1_6, 19.9, 1.0, 29.8/10 + 99.6, 5],
     [EIGEN_KERNEL, ENZYMES, R_2_6, 18.6, 1.3, 41.5/10 + 99.6, 10],
     [EIGEN_KERNEL, ENZYMES, R_3_6, 20.0, 0.9, 72.1/10 + 99.6, 16],
     [EIGEN_KERNEL, ENZYMES, R_4_6, 21.5, 0.9, 124.0/10 + 99.6, 21],
     [EIGEN_KERNEL, ENZYMES, R_5_6, 20.7, 1.0, 173.2/10 + 99.6, 27],
     [EIGEN_KERNEL, ENZYMES, R_6_6, 22.3, 1.4, 209.4/10 + 99.6, 32],
     [EIGEN_KERNEL, DD, R_1_6, 68.8, 1.3, 111.8/10 + 3117.9, 47],
     [EIGEN_KERNEL, DD, R_2_6, 72.1, 0.3, 167.3/10 + 3117.9, 94],
     [EIGEN_KERNEL, DD, R_3_6, 75.1, 0.2, 208.5/10 + 3117.9, 142],
     [EIGEN_KERNEL, DD, R_4_6, 75.2, 0.3, 245.1/10 + 3117.9, 189],
     [EIGEN_KERNEL, DD, R_5_6, 74.4, 0.3, 287.7/10 + 3117.9, 236],
     [EIGEN_KERNEL, DD, R_6_6, 74.0, 0.3, 310.6/10 + 3117.9, 284],
     [EIGEN_KERNEL, NCI1, R_1_6, 57.7, 0.2, 60.6/10 + 898.1, 4],
     [EIGEN_KERNEL, NCI1, R_2_6, 60.0, 0.2, 126.5/10 + 898.1, 9],
     [EIGEN_KERNEL, NCI1, R_3_6, 61.7, 0.1, 146.0/10 + 898.1, 14],
     [EIGEN_KERNEL, NCI1, R_4_6, 62.7, 0.4, 137.2/10 + 898.1, 19],
     [EIGEN_KERNEL, NCI1, R_5_6, 63.8, 0.2, 146.7/10 + 898.1, 24],
     [EIGEN_KERNEL, NCI1, R_6_6, 63.9, 0.2, 171.7/10 + 898.1, 29],
     [EIGEN_KERNEL, NCI109, R_1_6, 58.4, 0.1, 60.6/10 + 879.0, 4],
     [EIGEN_KERNEL, NCI109, R_2_6, 59.6, 0.1, 132.4/10 + 879.0, 9],
     [EIGEN_KERNEL, NCI109, R_3_6, 62.6, 0.2, 128.2/10 + 879.0, 14],
     [EIGEN_KERNEL, NCI109, R_4_6, 63.2, 0.4, 161.3/10 + 879.0, 19],
     [EIGEN_KERNEL, NCI109, R_5_6, 63.6, 0.5, 163.1/10 + 879.0, 24],
     [EIGEN_KERNEL, NCI109, R_6_6, 63.9, 0.1, 168.7/10 + 879.0, 29],
     [EIGEN_KERNEL, FLASH_CFG, R_1_6, 79.1, 3.0, 221.5/10 + 3387.9, 174],
     [EIGEN_KERNEL, FLASH_CFG, R_2_6, 79.8, 2.3, 320.4/10 + 3387.9, 348],
     [EIGEN_KERNEL, FLASH_CFG, R_3_6, 80.5, 3.0, 379.2/10 + 3387.9, 522],
     [EIGEN_KERNEL, FLASH_CFG, R_4_6, 82.0, 1.6, 431.2/10 + 3387.9, 696],
     [EIGEN_KERNEL, FLASH_CFG, R_5_6, 81.7, 1.7, 452.7/10 + 3387.9, 870],
     [EIGEN_KERNEL, FLASH_CFG, R_6_6, 81.3, 1.7, 466.4/10 + 3387.9, 1044],
