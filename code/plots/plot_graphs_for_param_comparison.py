...
DATA = np.array(
    [[WEISFEILER_LEHMAN, MUTAG, H_0, 85.5, 0.9, 15.7/10 + 0.1, 7],
     ...
     [EIGEN_KERNEL, MUTAG, R_1_6, 88.6, 0.5, 106.6/10 + 14.8, 100],
     [EIGEN_KERNEL, MUTAG, R_2_6, 88.6, 0.5, 106.6/10 + 14.8, 100],
     [EIGEN_KERNEL, MUTAG, R_3_6, 88.6, 0.5, 106.6/10 + 14.8, 100],
     [EIGEN_KERNEL, MUTAG, R_4_6, 88.6, 0.5, 106.6/10 + 14.8, 100],
     [EIGEN_KERNEL, MUTAG, R_5_6, 88.6, 0.5, 106.6/10 + 14.8, 100],
     [EIGEN_KERNEL, MUTAG, R_6_6, 88.6, 0.5, 106.6/10 + 14.8, 100],
     [EIGEN_KERNEL, PTC_MR, R_1_6, 61.9, 1.0, 130.4/10 + 62.5, 100],
     [EIGEN_KERNEL, PTC_MR, R_2_6, 61.9, 1.0, 130.4/10 + 62.5, 100],
     [EIGEN_KERNEL, PTC_MR, R_3_6, 61.9, 1.0, 130.4/10 + 62.5, 100],
     [EIGEN_KERNEL, PTC_MR, R_4_6, 61.9, 1.0, 130.4/10 + 62.5, 100],
     [EIGEN_KERNEL, PTC_MR, R_5_6, 61.9, 1.0, 130.4/10 + 62.5, 100],
     [EIGEN_KERNEL, PTC_MR, R_6_6, 61.9, 1.0, 130.4/10 + 62.5, 100],
     [EIGEN_KERNEL, ENZYMES, R_1_6, 25.7, 1.1, 803.2/10 + 99.6, 100],
     [EIGEN_KERNEL, ENZYMES, R_2_6, 25.7, 1.1, 803.2/10 + 99.6, 100],
     [EIGEN_KERNEL, ENZYMES, R_3_6, 25.7, 1.1, 803.2/10 + 99.6, 100],
     [EIGEN_KERNEL, ENZYMES, R_4_6, 25.7, 1.1, 803.2/10 + 99.6, 100],
     [EIGEN_KERNEL, ENZYMES, R_5_6, 25.7, 1.1, 803.2/10 + 99.6, 100],
     [EIGEN_KERNEL, ENZYMES, R_6_6, 25.7, 1.1, 803.2/10 + 99.6, 100],
     [EIGEN_KERNEL, DD, R_1_6, 75.9, 0.5, 1554.6/10 + 3117.9, 100],
     [EIGEN_KERNEL, DD, R_2_6, 75.9, 0.5, 1554.6/10 + 3117.9, 100],
     [EIGEN_KERNEL, DD, R_3_6, 75.9, 0.5, 1554.6/10 + 3117.9, 100],
     [EIGEN_KERNEL, DD, R_4_6, 75.9, 0.5, 1554.6/10 + 3117.9, 100],
     [EIGEN_KERNEL, DD, R_5_6, 75.9, 0.5, 1554.6/10 + 3117.9, 100],
     [EIGEN_KERNEL, DD, R_6_6, 75.9, 0.5, 1554.6/10 + 3117.9, 100],
     [EIGEN_KERNEL, NCI1, R_1_6, 64.4, 0.2, 929.7/10 + 898.1, 100],
     [EIGEN_KERNEL, NCI1, R_2_6, 64.4, 0.2, 929.7/10 + 898.1, 100],
     [EIGEN_KERNEL, NCI1, R_3_6, 64.4, 0.2, 929.7/10 + 898.1, 100],
     [EIGEN_KERNEL, NCI1, R_4_6, 64.4, 0.2, 929.7/10 + 898.1, 100],
     [EIGEN_KERNEL, NCI1, R_5_6, 64.4, 0.2, 929.7/10 + 898.1, 100],
     [EIGEN_KERNEL, NCI1, R_6_6, 64.4, 0.2, 929.7/10 + 898.1, 100],
     [EIGEN_KERNEL, NCI109, R_1_6, 64.5, 0.3, 964.3/10 + 879.0, 100],
     [EIGEN_KERNEL, NCI109, R_2_6, 64.5, 0.3, 964.3/10 + 879.0, 100],
     [EIGEN_KERNEL, NCI109, R_3_6, 64.5, 0.3, 964.3/10 + 879.0, 100],
     [EIGEN_KERNEL, NCI109, R_4_6, 64.5, 0.3, 964.3/10 + 879.0, 100],
     [EIGEN_KERNEL, NCI109, R_5_6, 64.5, 0.3, 964.3/10 + 879.0, 100],
     [EIGEN_KERNEL, NCI109, R_6_6, 64.5, 0.3, 964.3/10 + 879.0, 100],
     [EIGEN_KERNEL, FLASH_CFG, R_1_6, 79.7, 2.6, 2596.1/10 + 3387.9, 100],
     [EIGEN_KERNEL, FLASH_CFG, R_2_6, 79.7, 2.6, 2596.1/10 + 3387.9, 100],
     [EIGEN_KERNEL, FLASH_CFG, R_3_6, 79.7, 2.6, 2596.1/10 + 3387.9, 100],
     [EIGEN_KERNEL, FLASH_CFG, R_4_6, 79.7, 2.6, 2596.1/10 + 3387.9, 100],
     [EIGEN_KERNEL, FLASH_CFG, R_5_6, 79.7, 2.6, 2596.1/10 + 3387.9, 100],
     [EIGEN_KERNEL, FLASH_CFG, R_6_6, 79.7, 2.6, 2596.1/10 + 3387.9, 100],
     [EIGEN_KERNEL, ANDROID_FCG, R_1_6, 90.0, 0.0, 3600.0, 100],
     [EIGEN_KERNEL, ANDROID_FCG, R_2_6, 90.0, 0.0, 3600.0, 100],
     [EIGEN_KERNEL, ANDROID_FCG, R_3_6, 90.0, 0.0, 3600.0, 100],
     [EIGEN_KERNEL, ANDROID_FCG, R_4_6, 90.0, 0.0, 3600.0, 100],
     [EIGEN_KERNEL, ANDROID_FCG, R_5_6, 90.0, 0.0, 3600.0, 100],
     [EIGEN_KERNEL, ANDROID_FCG, R_6_6, 90.0, 0.0, 3600.0, 100]])
