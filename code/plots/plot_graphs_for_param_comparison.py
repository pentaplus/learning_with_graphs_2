...
DATA = np.array(
    [[WEISFEILER_LEHMAN, MUTAG, H_0, 85.5, 0.9, 15.7/10 + 0.1, 7],
     ...
     [WEISFEILER_LEHMAN, ANDROID_FCG, H_0, 93.5, 0.2, (1529.5/10 + 278.9)/3600, 4530],
     [WEISFEILER_LEHMAN, ANDROID_FCG, H_1, 93.6, 0.3, (5735.4/10 + 1073.5)/3600, 807181],
     [WEISFEILER_LEHMAN, ANDROID_FCG, H_2, 93.6, 0.2, (11029.5/10 + 2508.2)/3600, 1953948],
     [WEISFEILER_LEHMAN, ANDROID_FCG, H_3, 93.3, 0.2, (16799.5/10 + 4806.8)/3600, 3175014],
     [WEISFEILER_LEHMAN, ANDROID_FCG, H_4, 93.6, 0.1, (23409.4/10 + 7998.7)/3600, 4418993],
     [WEISFEILER_LEHMAN, ANDROID_FCG, H_5, 93.5, 0.3, (32145.7/10 + 12247.7)/3600, 5673882],
     ...
     [COUNT_SENS_NEIGH_HASH, DD, H_0, 76.8, 1.1, 51.3/10 + 2.6, 82],
     [COUNT_SENS_NEIGH_HASH, DD, H_1, 71.8, 0.4, 44.6/10 + 9.5, 164726],
     [COUNT_SENS_NEIGH_HASH, DD, H_2, 51.3, 0.4, 31.3/10 + 16.3, 301015],
     [COUNT_SENS_NEIGH_HASH, DD, H_3, 43.0, 0.2, 31.5/10 + 23.2, 322998],
     [COUNT_SENS_NEIGH_HASH, DD, H_4, 42.6, 0.3, 31.4/10 + 30.1, 324659],
     [COUNT_SENS_NEIGH_HASH, DD, H_5, 42.0, 0.1, 31.6/10 + 37.0, 324858],
     ...
     [COUNT_SENS_NEIGH_HASH, ANDROID_FCG, H_0, 92.0, 1.3, (1523.2/10 + 1640.3)/3600, 4530],
     [COUNT_SENS_NEIGH_HASH, ANDROID_FCG, H_1, 94.4, 0.1, (4410.1/10 + 2435.5)/3600, 742522],
     [COUNT_SENS_NEIGH_HASH, ANDROID_FCG, H_2, 94.6, 0.0, (4958.5/10 + 3513.3)/3600, 996877],
     [COUNT_SENS_NEIGH_HASH, ANDROID_FCG, H_3, 94.5, 0.0, (5153.8/10 + 4816.1)/3600, 1161715],
     [COUNT_SENS_NEIGH_HASH, ANDROID_FCG, H_4, 94.4, 0.1, (4862.7/10 + 6269.6)/3600, 1104893],
     [COUNT_SENS_NEIGH_HASH, ANDROID_FCG, H_5, 94.5, 0.0, (5067.1/10 + 7755.4)/3600, 1182199],
...
#     [COUNT_SENS_NEIGH_HASH_ALL_ITER, ANDROID_FCG, H_0, 93.0, 0.8, (1585.0/10 + 1699.1)/3600, 4530],
#     [COUNT_SENS_NEIGH_HASH_ALL_ITER, ANDROID_FCG, H_1, 93.7, 0.5, (5810.0/10 + 2534.5)/3600, 746670],
#     [COUNT_SENS_NEIGH_HASH_ALL_ITER, ANDROID_FCG, H_2, 93.5, 0.7, (11434.9/10 + 3946.7)/3600, 1698312],
#     [COUNT_SENS_NEIGH_HASH_ALL_ITER, ANDROID_FCG, H_3, 93.4, 0.6, (17808.0/10 + 6107.2)/3600, 2740659],
#     [COUNT_SENS_NEIGH_HASH_ALL_ITER, ANDROID_FCG, H_4, 93.7, 0.1, (23960.5/10 + 8987.9)/3600, 3663995],
#     [COUNT_SENS_NEIGH_HASH_ALL_ITER, ANDROID_FCG, H_5, 93.4, 0.2, (31428.6/10 + 12731.0)/3600, 4587380],
     ...
     [EIGEN_KERNEL, DD, R_1_6, 68.8, 1.3, (111.8/10 + 1012.6)/60, 47],
     [EIGEN_KERNEL, DD, R_2_6, 72.1, 0.3, (167.3/10 + 1814.0)/60, 94],
     [EIGEN_KERNEL, DD, R_3_6, 75.1, 0.2, (208.5/10 + 2383.6)/60, 142],
     [EIGEN_KERNEL, DD, R_4_6, 75.2, 0.3, (245.1/10 + 2777.8)/60, 189],
     [EIGEN_KERNEL, DD, R_5_6, 74.4, 0.3, (287.7/10 + 3050.7)/60, 236],
     [EIGEN_KERNEL, DD, R_6_6, 74.0, 0.3, (310.6/10 + 3225.1)/60, 284],
     [EIGEN_KERNEL, NCI1, R_1_6, 57.7, 0.2, (60.6/10 + 260.8)/60, 4],
     [EIGEN_KERNEL, NCI1, R_2_6, 60.0, 0.2, (126.5/10 + 522.3)/60, 9],
     [EIGEN_KERNEL, NCI1, R_3_6, 61.7, 0.1, (146.0/10 + 698.8)/60, 14],
     [EIGEN_KERNEL, NCI1, R_4_6, 62.7, 0.4, (137.2/10 + 808.6)/60, 19],
     [EIGEN_KERNEL, NCI1, R_5_6, 63.8, 0.2, (146.7/10 + 874.5)/60, 24],
     [EIGEN_KERNEL, NCI1, R_6_6, 63.9, 0.2, (171.7/10 + 914.9)/60, 29],
     [EIGEN_KERNEL, NCI109, R_1_6, 58.4, 0.1, (60.6/10 + 259.5)/60, 4],
     [EIGEN_KERNEL, NCI109, R_2_6, 59.6, 0.1, (132.4/10 + 517.9)/60, 9],
     [EIGEN_KERNEL, NCI109, R_3_6, 62.6, 0.2, (128.2/10 + 689.0)/60, 14],
     [EIGEN_KERNEL, NCI109, R_4_6, 63.2, 0.4, (161.3/10 + 795.6)/60, 19],
     [EIGEN_KERNEL, NCI109, R_5_6, 63.6, 0.5, (163.1/10 + 859.0)/60, 24],
     [EIGEN_KERNEL, NCI109, R_6_6, 63.9, 0.1, (168.7/10 + 899.0)/60, 29],
     [EIGEN_KERNEL, FLASH_CFG, R_1_6, 79.1, 3.0, (221.5/10 + 1685.2)/60, 174],
     [EIGEN_KERNEL, FLASH_CFG, R_2_6, 79.8, 2.3, (320.4/10 + 2268.5)/60, 348],
     [EIGEN_KERNEL, FLASH_CFG, R_3_6, 80.5, 3.0, (379.2/10 + 2646.6)/60, 522],
     [EIGEN_KERNEL, FLASH_CFG, R_4_6, 82.0, 1.6, (431.2/10 + 2966.3)/60, 696],
     [EIGEN_KERNEL, FLASH_CFG, R_5_6, 81.7, 1.7, (452.7/10 + 3215.6)/60, 870],
     [EIGEN_KERNEL, FLASH_CFG, R_6_6, 81.3, 1.7, (466.4/10 + 3542.6)/60, 1044],
     [EIGEN_KERNEL, ANDROID_FCG, R_1_6, 90.3, 2.3, (2332.2/10 + 14951.6)/3600, 307],
     [EIGEN_KERNEL, ANDROID_FCG, R_2_6, 87.4, 3.8, (3806.3/10 + 28330.0)/3600, 615],
     [EIGEN_KERNEL, ANDROID_FCG, R_3_6, 89.3, 1.9, (4939.4/10 + 39367.0)/3600, 923],
     [EIGEN_KERNEL, ANDROID_FCG, R_4_6, 85.6, 2.2, (5694.9/10 + 48818.0)/3600, 1231],
     [EIGEN_KERNEL, ANDROID_FCG, R_5_6, 91.0, 0.9, (6468.5/10 + 56604.0)/3600, 1539],
     [EIGEN_KERNEL, ANDROID_FCG, R_6_6, 87.6, 3.1, (7168.6/10 + 62868.8)/3600, 1847]])
...
#            plt.grid(color = GREY)
            ...
            if mode == SCORES:
                ...
                if embedding == EIGEN_KERNEL and dataset in [DD, NCI1, NCI109,
                                                             FLASH_CFG]:
...
#    ax.text(0.5, y, '\\normalsize \\textbf{(b)} \\textit{Count-sensitive neigborhood hash kernel (all it.)}',
    ax.text(0.5, y, '\\normalsize \\textbf{(b)} \\textit{Count-sensitive neigborhood hash kernel}',
            horizontalalignment = 'center',
            verticalalignment = 'center',
            transform = fig.transFigure)
