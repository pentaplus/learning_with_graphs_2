...
DATA_SD = np.array(
    [[WEISFEILER_LEHMAN, MUTAG, 91.3, 0.8, 110.3/10 + 0.6],
     ...
     [SHORTEST_PATH_KERNEL, MUTAG, 86.1, 1.3, 34.3/10 + 0.3],
     [SHORTEST_PATH_KERNEL, PTC_MR, 56.3, 1.6, 1101.0/10 + 0.8],
     [SHORTEST_PATH_KERNEL, ENZYMES, 25.3, 2.5, 14979.0/10 + 2.4],
...
DATA_LD = np.array(
    [[WEISFEILER_LEHMAN, DD, 79.1, 0.5, 2170.2/10 + 31.9],
     ...
     [WEISFEILER_LEHMAN, ANDROID_FCG, 93.9, 0.1, 105315.5/10 + 12295.0],
     [NEIGHBORHOOD_HASH, DD, 76.8, 0.9, 253.7/10 + 22.2],
     ...
     [NEIGHBORHOOD_HASH, ANDROID_FCG, 94.6, 0.1, 27575.8/10 + 7507.8],
     [COUNT_SENSITIVE_NEIGHBORHOOD_HASH, DD, 76.3, 1.1, 263.5/10 + 37.9],
     ...
     [COUNT_SENSITIVE_NEIGHBORHOOD_HASH, ANDROID_FCG, 94.6, 0.1, 31028.3/10 + 7779.1], 
     [COUNT_SENSITIVE_NEIGHBORHOOD_HASH_ALL_ITER, DD, 78.5, 1.0,
      2265.1/10 + 42.9],
     ...
     [COUNT_SENSITIVE_NEIGHBORHOOD_HASH_ALL_ITER, FLASH_CFG, 86.2, 0.4,
      666.8/10 + 143.0],
     [COUNT_SENSITIVE_NEIGHBORHOOD_HASH_ALL_ITER, ANDROID_FCG, 93.3, 0.8, 106281.2/10 + 12801.0],
     ...
     [GRAPHLET_KERNEL_3, ANDROID_FCG, 64.8, 7.6, 182.5/10 + 608.8],
     ...
     [SHORTEST_PATH_KERNEL, DD, 67.4, 2.0, 52.3/10 + 5269.1],
     [SHORTEST_PATH_KERNEL, NCI1, 65.1, 0.9, 167.6/10 + 12.4],
     [SHORTEST_PATH_KERNEL, NCI109, 64.5, 0.9, 165.4/10 + 12.2],
     [SHORTEST_PATH_KERNEL, FLASH_CFG, 0.0, 0.0, 2*24*60*60],
     [SHORTEST_PATH_KERNEL, ANDROID_FCG, 0.0, 0.0, 2*24*60*60],
     ...
     [RANDOM_WALK_KERNEL, ANDROID_FCG, 0.0, 0.0, 2*24*60*60],
     ...
     [EIGEN_KERNEL, ANDROID_FCG, 89.9, 2.2, 35149.8/10 + 59154.0]])
